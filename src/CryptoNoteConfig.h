...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x39d362; // addresses start with prefix "euor"
...
const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "laroue-blocks.bin";
const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "laroue-blockindexes.bin";
const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "laroue-poolstate.bin";
const char     P2P_NET_DATA_FILENAME[]                       = "laroue-p2pstate.bin";
const char     MINER_CONFIG_FILE_NAME[]                      = "laroue-miner_conf.json";
} // parameters

// Change the name of your coin lol
const char     CRYPTONOTE_NAME[]                             = "laroue";
...
const int      P2P_DEFAULT_PORT                              =  37236; // P2P blockchain port
const int      RPC_DEFAULT_PORT                              =  38236; // JSON RPC port
...
const char* const SEED_NODES[] = {
  "192.168.0.14:37236", // CHANGE YOUR FUCKIN SEED NODES
  "192.168.0.19:38236", // CHANGE YOUR FUCKIN SEED NODES
};
